function [RegisteredImage,MOVINGREG] = registerImages(MOVING,FIXED)
...
% Auto-generated by registrationEstimator app on 16-Aug-2020
%-----------------------------------------------------------
...
RegisteredImage = imwarp(MOVING0, movingRefObj, tform, 'OutputView', fixedRefObj, 'SmoothEdges', true);
