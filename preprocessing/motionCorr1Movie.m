function [mov_corrected,bestCorner]=motionCorr1Movie(input,varargin)
%% mocoMovies
% SYNTAX
...
if ischar(input)
    ...
    if strcmpi(ext,'.h5')
        ...
        options.mocoMoviePath=strrep(h5Path,'.h5','_moco.h5');
        options.mocoMoviePathTemp=strrep(h5Path,'.h5','_mocoTEMP.h5');
