function [MOVINGREG] = registerImagesSurfNonRigid_v3(MOVING,FIXED)
...
fixedPoints = detectSURFFeatures(FIXED,'MetricThreshold',600,'NumOctaves',3,'NumScaleLevels',5);
movingPoints = detectSURFFeatures(MOVING,'MetricThreshold',600,'NumOctaves',3,'NumScaleLevels',5);
...
% Match features
indexPairs = matchFeatures(fixedFeatures,movingFeatures,'MatchThreshold',25,'MaxRatio',0.25);
