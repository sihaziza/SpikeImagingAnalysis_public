function [MOVINGREG] = registerImagesSurfNonRigid(MOVING,FIXED)
...
fixedPoints = detectSURFFeatures(FIXED,'MetricThreshold',626.736111,'NumOctaves',3,'NumScaleLevels',5);
movingPoints = detectSURFFeatures(MOVING,'MetricThreshold',626.736111,'NumOctaves',3,'NumScaleLevels',5);
...
% Match features
indexPairs = matchFeatures(fixedFeatures,movingFeatures,'MatchThreshold',24.652778,'MaxRatio',0.246528);
...
[MOVINGREG.DisplacementField,MOVINGREG.RegisteredImage] = imregdemons(MOVINGREG.RegisteredImage,FIXED,100,'AccumulatedFieldSmoothing',2.0,'PyramidLevels',3);
